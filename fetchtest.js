...
fetch('https://app.hygraph.com/clone/ad627648114e4f7ca0747f4f60dfc107?name=Employee%20Payslip', {
  ...
  body: JSON.stringify({ query: '{ employees(first: 100) { employeeName employeeId designation department dateOfJoining bankName bankAccountNo panNo uanNo pfNo company } }' })
})
  .then(r => r.json())
